...
def main():
  ...
  plistpath = scriptpath + "/resources/Delorean-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delorean-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delorean-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delorean-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delorean-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delorean-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Delorean-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Delorean.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Delorean.iss",inplace=1):
